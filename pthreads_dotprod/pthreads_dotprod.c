...
int main(int argc, char **argv)
{
   ...
   printf("NThreads : "); scanf("%d",&nthreads);
   printf("Worksize : "); scanf("%d",&wsize);// worksize = tamanho do vetor de cada thread
   printf("Reps : ");     scanf("%d",&repeat); // numero de repeticoes dos calculos (para aumentar carga)
